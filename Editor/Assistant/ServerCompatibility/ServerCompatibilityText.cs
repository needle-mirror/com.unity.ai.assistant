namespace Unity.AI.Assistant.Editor.ServerCompatibility
{
    static class ServerCompatibilityText
    {
        ...
        public static string NotSupportedMessage = $"The com.unity.ai.assistant package you currently have installed does not support the current server. Please update your package to the latest version. <link={NotSupportedMessageLink}><color=#7BAEFA>Update in Package Manager</color></link>";
