...
namespace Unity.AI.Assistant.Editor
{
    ...
    {
        static readonly string k_ErrorTitle = "An error has occurred";
        static readonly string k_ErrorMessagePrefix = k_ErrorTitle + ". ";
        ...
        public static string GetErrorTitle() => k_ErrorTitle;

        public static string GetErrorMessage(int errorCode, string errorText, string messageContent, bool addErrorPrefix = true)
        {
            string errorMessage;
            ...
            string GetErrorMessageFromErrorText(Dictionary<string, string> lookup)
            {
                ...
                foreach (var errorCodeLookUp in lookup.Keys)
                {
                    if (errorText.Contains(errorCodeLookUp))
                    {
                        ...
                        {
                            var result = (addErrorPrefix ? k_ErrorMessagePrefix : "") + userMessage;
